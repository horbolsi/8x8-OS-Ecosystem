...
Historical public web/deployment carrier and donor for Gates, Telegram/public surfaces, launch UI, and earlier integrated ecosystem experiences.
...
Only deployments explicitly mapped to this repo and proven by fresh deployment receipts.
...
Must consume public protocol and current user-edition/core-approved projections.
...
Public hosting/Vercel or preview environments; production identity must be proven from source commit to deployment.
...
A reachable URL is not proof of feature productivity; historical carrier naming must not imply canonical source authority.
